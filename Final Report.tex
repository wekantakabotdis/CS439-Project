...
\author{%
  Yining Chen \quad Michael Chiu \quad Ryan Xu\\
  CS 439: Introduction to Data Science\\
  Section 7\\
  NetIDs: \texttt{ycc30}, \texttt{mkc149}, \texttt{rwx1}
}
...
\begin{center}
\vspace{0.4em}
{\small\textbf{Project Links}\\[0.2em]
\href{https://github.com/wekantakabotdis/CS439-Project}{GitHub Repository}
\hspace{2em}
\href{https://www.youtube.com/watch?v=aPlrV3W4zwg}{Project Video}}
\end{center}
\end{abstract}
